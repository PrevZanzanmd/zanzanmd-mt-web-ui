...
class Card extends React.Component{
	...
	openNotification = _ => (<div>
		<p>1.什么是赞赞红包？</p>
		<p>赞赞红包是为赞赞发行和认可的购物券，可在赞赞APP下单时使用，可抵扣相应的金额。</p>
		<p>２.赞赞红包可以找零兑换吗？</p>
		<p>赞赞红包不找零、不兑换。</p>
		<p>３.赞赞红包可以在其他平台使用吗？</p>
		<p>赞赞红包仅限在赞赞客户端内使用，不可在微信钱包、手机QQ等其他平台使用。</p>
		<p>4.赞赞红包的使用条件？</p>
		<p>赞赞红包需同时满足以下条件才可用：</p>
		<p>1)仅在线支付使用。</p>
		<p>2)仅限在发该商家红包的店铺使用。</p>
		<p>3)满足红包上的使用条件。</p>
		<p>注意事项：</p>
		<p>红包/优惠券一切费用由商家承担，与赞赞平台无关</p>
		<p>1.什么是赞赞优惠券？</p>
		<p>赞赞优惠券是商家自己发行的，在用户下单时可用于自己店铺内的优惠券，可抵扣相应的金额。</p>
		<p>2.赞赞优惠券可以找零、兑换吗？</p>
		<p> 赞赞优惠券不找零、不兑换。</p>
		<p>３.赞赞优惠券可以在其他平台使用吗？</p>
		<p>赞赞优惠券仅限在赞赞客户端内使用，不可在微信钱包、手机QQ等其他平台使用</p>
		<p>4.赞赞优惠券的使用条件？</p>
		<p>赞赞优惠券需同时满足以下条件才可用：</p>
		<p>(1)仅在线支付使用。</p>
		<p>(2)仅限在发该商家券的店铺使用。</p>
		<p>(3)满足优惠券上的使用条件。</p>
		<p>注意事项：</p>
